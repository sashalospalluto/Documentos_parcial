...
void socio_hardcodeo(Socio arraySocio[])
{
    ...
    strcpy(arraySocio[1].nombre,"Juan");//Juan Manuel
    ...
    strcpy(arraySocio[3].nombre,"Ricardo");//Sandra Angelica
    strcpy(arraySocio[3].apellido,"Rojas");
    arraySocio[3].sexo='f';
    arraySocio[3].telefono=1165808344;
    strcpy(arraySocio[3].email,"ricardo@hotmail.com");
    arraySocio[3].dia=26;
    arraySocio[3].mes=01;
